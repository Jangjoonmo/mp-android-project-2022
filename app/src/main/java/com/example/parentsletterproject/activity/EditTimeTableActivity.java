...
public class EditTimeTableActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init(){
        ...
        professorEdit = findViewById(R.id.details_edit);
    ...
    /** check whether
     * the mode is ADD or EDIT */
    private void checkMode(){
        Intent i = getIntent();
        mode = i.getIntExtra("mode", EditTimeTableMain.REQUEST_ADD);

        if(mode == EditTimeTableMain.REQUEST_EDIT){
            loadScheduleData();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.submit_btn:
                if(mode == EditTimeTableMain.REQUEST_ADD){
                    inputDataProcessing();
                    Intent i = new Intent();
                ...
                else if(mode == EditTimeTableMain.REQUEST_EDIT){
                    inputDataProcessing();
                    Intent i = new Intent();
                    ArrayList<Schedule> schedules = new ArrayList<Schedule>();
                    schedules.add(schedule);
